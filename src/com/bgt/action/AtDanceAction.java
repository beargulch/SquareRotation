...
public class AtDanceAction extends AbstractAction
{
	...
	public void actionPerformed(ActionEvent e)
    {
	    ...
	    if (partnerIx > -1) dancersTmdl.setValueAt((Boolean)atDance, partnerIx, Dancer.DANCER_AT_DANCE_IX);
	    
	    // if we just marked this dancer (and partner, if one exists) not at the dance, we turn off the must dance flag if it is set.
